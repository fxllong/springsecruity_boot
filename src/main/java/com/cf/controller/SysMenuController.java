...
public class SysMenuController {
	...
	public R perms(){
		...
		if(getCurrentUser().getUserId() == Constant.SUPER_ADMIN){
			...
			menuList = sysMenuService.queryUserList(getCurrentUser().getUserId());
		}
	...
	public R user(){
		//根据用户查询菜单
	List<SysMenuEntity> menuList = sysMenuService.getUserMenuList(getCurrentUser().getUserId());
		//根据用户查询权限
	Set<String> permissions = sysMenuService.getUserPermissions(getCurrentUser().getUserId());
